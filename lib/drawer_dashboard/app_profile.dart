...
import 'package:flutter/material.dart';import 'package:SKS_Matka/Shared/constant.dart';
                        ...
                        Row(children: [
                          Padding(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, Routes.ACCOUNT_DETAILS);
                              },
                              child: Container(
                          ...
                          Row(children: [
                            Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.pushNamed(
                                      context, Routes.GOOGLEPAY_DETAILS);
                                },
                                child: Container(
                                  width:
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.pushNamed(
                                      context, Routes.PHONEPE_DETAILS);
                                },
                                child: Container(
                                  width:
                                      MediaQuery.of(context).size.width / 2.35,
