...
class _HomePageState extends State<HomePage> {
  ...
  Future init() async {
    ...
    setState(() {});
    slidesList = await GameService.getInstance().fetchSliderData();
    setState(() {});
  }
