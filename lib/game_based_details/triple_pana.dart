...
class TriplePana extends StatefulWidget {
  const TriplePana({Key? key}) : super(key: key);

  @override
  _TriplePanaState createState() => _TriplePanaState();
}

class _TriplePanaState extends State<TriplePana> {
