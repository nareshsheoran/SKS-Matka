...
class GaliGameJodiDigit extends StatefulWidget {
  const GaliGameJodiDigit({Key? key}) : super(key: key);

  @override
  _GaliGameJodiDigitState createState() => _GaliGameJodiDigitState();
}

class _GaliGameJodiDigitState extends State<GaliGameJodiDigit> {
