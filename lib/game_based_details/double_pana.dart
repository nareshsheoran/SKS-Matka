...
class DoublePana extends StatefulWidget {
  const DoublePana({Key? key}) : super(key: key);

  @override
  _DoublePanaState createState() => _DoublePanaState();
}

class _DoublePanaState extends State<DoublePana> {
